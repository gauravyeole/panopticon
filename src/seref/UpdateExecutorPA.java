...
public class UpdateExecutorPA<T> implements Callable<Integer>, Serializable, HazelcastInstanceAware {
    ...
    public UpdateExecutorPA() {
    }

    public UpdateExecutorPA(T keyM, Class clazz, int nodeCount, int partitionCount, String job, long myID, int wNum) {
        this.keyM = keyM;
        this.clazz = clazz;
